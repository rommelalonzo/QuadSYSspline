...
void quadSYSspline::process(double time, Eigen::VectorXf current_state){
...
void quadSYSspline::NN1Estimation(){
	error1 = this->zetaDot - this->zeta;
	error1Dot = this->zetaDDot1 - this->zetaDot;
	r1 = error1Dot + (lambda1 * error1);
